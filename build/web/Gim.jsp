                        ...
                        <c:choose>
                            <c:when test="${GimForm.flagMueOcuForm=='muestra'}">       
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <html:text alt="Ruta" property="pathServidor" styleId="pathServidor"    styleClass="form-control input-sm upper"></html:text>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>                                                
                                ...
                                <div class="accion-line aright">                                      
                                    ...
                                    <button title="Confirmar" id="btnConfirmarRuta"   class="btn btn-sm btn-success"   type="button" ><%=Constantes.ICON_CHECK%> Confirmar</button>                                                                                
                            </div>                                                                      
                        </c:when>
                        <c:otherwise> 
                            <div class="accion-line aright">
