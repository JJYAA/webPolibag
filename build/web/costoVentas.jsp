    ...
    <body id="main-wrapper">
        ...
        <div class="widget">
            <div class="widget-content" id="main-content">
                ...
                <html:form action="/costoVentaAction" styleId="frm_generico" method="POST" styleClass="form-horizontal">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class="col-md-1">
                                                <button  id="exportButton" disabled="true" class="btn btn-sm btn-danger"><span class="fa fa-file-excel-o"></span> Exportar Costos</button>
                                            </div> 
 
                                    </div>       
                                </div>         
                            </div>
                            <div id="c_tablaCostodeVentas"></div>   
                            <div class="accion-line aright">      
                                    <button title="Confirmar" id="btnConAsientoVentas" class="btn btn-sm btn-success"   type="button" ><%=Constantes.ICON_CHECK%> Genera Asientos Costos</button> 
                                    <button title="Eliminar" id="btnEliminarVentas" onclick="EliminarAsientos(2);" class="btn btn-sm btn-success"   type="button" ><%=Constantes.ICON_CLEAR%> Eliminar Asientos Costos</button>                                                                                
                            </div>                            
                        </c:when>
                        <c:otherwise> 
                            <div class="accion-line aright">
        ...
        <script type="text/javascript" src="js/funciones/jsCostoVentas.js"></script>
    </body>
</html:html>