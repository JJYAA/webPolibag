        ...
        <div class="widget">
            <div class="widget-content" id="main-content">
                <ol class="breadcrumb">
                    ...
                    <li>Transferencias de Cobranzas</li>
                </ol>
                        ...
                        <c:when test="${CobranzasForm.flagMueOcuForm=='muestra'}">                     
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class="col-md-1">
                                                <button onclick="excelCobranzas();" id="exportButton" disabled="true" class="btn btn-sm btn-danger clearfix"><span class="fa fa-file-excel-o"></span> Exportar Cobranza</button>
                                            </div>   
                                        </div>                                           
                                    </div>
                                </div>
                                ...
                                <div class="accion-line aright">      
                                    <button title="Confirmar" id="btnConAsientoCobranza" class="btn btn-sm btn-success"   type="button" ><%=Constantes.ICON_CHECK%> Genera Asientos Cobranzas</button> 
                                <button title="Eliminar" id="btnEliminarVentas" onclick="EliminarAsientos();" class="btn btn-sm btn-success"   type="button" ><%=Constantes.ICON_CLEAR%> Eliminar Asientos Cobranza</button>                                                                                
                            </div>
                        </c:when>
                        <c:otherwise> 
                            <div class="accion-line aright">
